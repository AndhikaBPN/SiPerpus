				...
				<div class="card" style="width: 100%">
					...
					<form action="edit-proses1.php" method="post">
						<table class="table">
							...
							<tr>
								<td>Ringkasan</td>
								<td style=""><textarea style="width: 100%; height: 100px" value="<? $buku['cover']; ?>" type="textarea" name="ringkasan" required></textarea></td>
							</tr>
							<tr>
								<td>Stok</td>
							...
							<tr>
								<th></th>
								<th><button type="submit" class="btn btn-primary" name="simpan" style="width: 100%; height: 70px">Edit</button></th>
							</tr>
						</table>
					</form>
				</div>
