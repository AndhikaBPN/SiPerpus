...
$sql = "SELECT * FROM peminjaman p INNER JOIN detail_pinjam dp ON p.id_pinjam=dp.id_pinjam 
        INNER JOIN buku b ON b.id_buku=dp.id_buku 
        ...
        <div class="col-md-7">
            ...
            <hr  class="bg-light">
                <table class="table table-bordered">
                    ...
                    if ($denda > 0) { ?>
                        <tr>
                            <td class="table-danger" colspan="2"><strong>Denda yang harus dibayar: </strong>Rp <?= $denda;?></td>
                        </tr>
                    <?php
                    }
                    ?>
