                ...
                <div class="card-body">
                    <form action="proses-edit.php">
                        <div class="form-group">
                            ...
                            <input type="text" name="" value="<?= $id_pinjam['nama'];?>" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label for="datepicker">Tanggal Pinjam</label>
                            <input type="date" name="tgl_pinjam" value="<?= $id_pinjam['tgl_pinjam'];?>" class="form-control" disabled>
                        </div>
                        <?php
